...
class Game:
    def __init__(self, width, height):
        ...
        self.bg_img = pygame.image.load("res/spr_space_himmel.png")
    ...
    def print_score(self):
        sc_font = pygame.font.Font("freesansbold.ttf", 24)
        sc_text = sc_font.render("Score: " + str(self.score), True, (255, 255, 255))
        self.screen.blit(sc_text, (8, 8))
...
class Spaceship:
    def __init__(self, game, x, y):
        ...
        self.change_y = 0
        self.game = game
        self.sp_img = pygame.image.load("res/spr_spaceship.png")
        self.bullets = []
    ...
    def update(self):
        ...
        if self.x < 0:
            ...
            self.x = 736
        self.game.screen.blit(self.sp_img, (self.x, self.y))
...
class Bullet:
    def __init__(self, game, x, y):
        ...
        self.is_fired = False
        self.bullet_speed = 5
        self.bull_img = pygame.image.load("res/spr_patrone.png")
    ...
    def update(self):
        ...
        if self.y <= 0:
            self.is_fired = False
        self.game.screen.blit(self.bull_img, (self.x, self.y))
...
class Enemy:
    def __init__(self, game, x ,y):
        ...
        self.change_y = 60
        self.game = game
        self.alien_img = pygame.image.load("res/spr_space_enemy.png")
